      ...
      setUserFormErr({
        ...
        passwordErr:
          e.target.value.length === 0
            ...
            : /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@#\$%\*])(?=.{8,})/.test(e.target.value)
              ? null
      ...
      <Card.Body>
        <form onSubmit={(e) => submitForm(e)}>
          <div className="mb-3">
            ...
            <input
              type="text"
              className={`form-control ${userFormErr.nameErr ? "border-danger" : ""
                }`}
              id="name"
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              className={`form-control ${userFormErr.nationalIDErr ? "border-danger" : ""
                }`}
              id="nationalId"
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              className={`form-control ${userFormErr.addressErr ? "border-danger" : ""
                }`}
              id="address"
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              className={`form-control ${userFormErr.phoneErr ? "border-danger" : ""
                }`}
              id="phone"
          ...
          <div className="mb-3">
            ...
            <input className="form-control" type="file" id="profileImg"
          ...
          <div className="form-check">
            <input
              ...
              name="type"
              value="business"
              checked={userForm.type === "business"}
              id="type"
